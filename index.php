<html>
<head>
<title>Adam Sandler Web Service Demo</title>
<style>
...
$(document).ready(function() {  
	...
	<body>
	<h1>Adam Sandler Web Service</h1>
  <p>This website demonstrates storing data by using JSON, this web service with show 5 films by Adam Sandler</p>
		<a href="year" class="category">Adam Sandler By Year</a><br />
		<a href="box" class="category">Adam Sandler By Box Office</a>
